    ...
    fn add_mags(mut ui_a: u32, mut ui_b: u32) -> Self {
        ...
        let u_z = if N == 2 {
            ...
            if shift_right == 0 {
                ...
                let rcarry = (0x8000000000000000 & frac64_a) != 0; //first left bit
                if rcarry {
                    if exp_a != 0 {
                        k_a += 1;
                    }
            ...
            if reg_a > (N - 2) {
                ...
                //remove hidden bits
                frac64_a = (frac64_a & 0x3FFFFFFFFFFFFFFF) >> reg_a + 1; // 2 bits exp
                ...
                if reg_a < N {
                    if reg_a != (N - 2) {
                        bit_n_plus_one = ((0x8000000000000000_u64 >> N) & frac64_a) != 0;
                    } else if frac64_a > 0 {
                        frac_a = 0;
                    }
                ...
                if bit_n_plus_one {
                    let bits_more = if ((0xFFFF_FFFF_FFFF_FFFF_u64 >> N) & frac64_a) != 0 {
                        true
                    } else {
                        false
                    };
